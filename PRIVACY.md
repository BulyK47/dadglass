...
**Short version: DadGlass does not collect, transmit, or share any personal data. Everything you enter stays on your device.**

- **No accounts, no servers, no tracking.** DadGlass has no backend. It does not use analytics, advertising, or third‑party trackers.
- **On‑device only.** Anything you enter — your name and your partner's name, the baby's nickname, due date / week, journal entries, checklist state, appointment notes, and reminders — is stored **locally in your browser/app storage on your device** (`localStorage`). It never leaves your device and we never see it.
...
**Contact:** For any privacy question or data request, write to **dadglass.app@gmail.com**.
Because nothing you enter ever leaves your device, we hold no personal data about you and
therefore cannot access, export, or delete it on your behalf — you are always in control of
it directly in the app (Profile → "Reset all my data").

---

## Română

**Pe scurt: DadGlass nu colectează, nu transmite și nu partajează niciun fel de date personale. Tot ce introduci rămâne pe dispozitivul tău.**

- **Fără conturi, fără servere, fără urmărire.** DadGlass nu are backend. Nu folosește analytics, reclame sau trackere terțe.
- **Doar pe dispozitiv.** Tot ce introduci — numele tău și al partenerei, porecla bebelușului, data probabilă / săptămâna, notițele din jurnal, checklist‑ul, notițele de la programări și memento‑urile — este stocat **local, pe dispozitivul tău** (`localStorage`). Nu părăsește dispozitivul și noi nu îl vedem niciodată.
...
**Contact:** Pentru orice întrebare legată de confidențialitate sau cerere privind datele,
scrie la **dadglass.app@gmail.com**.
Pentru că nimic din ce introduci nu părăsește vreodată dispozitivul tău, nu deținem date
personale despre tine și, prin urmare, nu le putem accesa, exporta sau șterge în numele tău —
controlul îți aparține direct, în aplicație (Profil → „Șterge toate datele mele").
